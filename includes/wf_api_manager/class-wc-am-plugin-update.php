...
class WF_API_Manager_Software_Update {
	...
	public function expired_license_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The license key for %1$s has expired. You can reactivate or purchase a license key from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function on_hold_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s is on-hold. You can reactivate the subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function cancelled_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s has been cancelled. You can renew the subscription from your account <a href="%2$s" target="_blank">dashboard</a>. A new license key will be emailed to you after your order has been completed.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function expired_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s has expired. You can reactivate the subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function suspended_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s has been suspended. You can reactivate the subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function pending_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s is still pending. You can check on the status of the subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function trash_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'The subscription for %1$s has been placed in the trash and will be deleted soon. You can purchase a new subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function no_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A subscription for %1$s could not be found. You can purchase a subscription from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function no_key_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'A license key for %1$s could not be found. Maybe you forgot to enter a license key when setting up %2$s, or the key was deactivated in your account. You can reactivate license key at your plugin <a href="%3$s" target="_blank">settings page</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->product_id, $this->plugin_settings_url );
	...
	public function download_revoked_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'Download permission for %1$s has been revoked possibly due to a license key or subscription expiring. You can reactivate or purchase a license key from your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
	...
	public function no_activation_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( '%1$s has not been activated. Go to the plugin <a href="%2$s" target="_blank">settings page</a> and enter the license key and license email to activate %3$s.', $this->text_domain ) . '</p></div>', $this->product_id, $this->plugin_settings_url, $this->product_id );
	...
	public function switched_subscription_error_notice( $message ) {
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %1$s, so you will need to enter your new API License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account <a href="%2$s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->my_account_url );
